...
export default class LmbPluginInsertComponent extends Component<Args> {
  ...
  onInsert(mandatee: Mandatee) {
    ...
    const firstNameNode = schema.node('inline_rdfa', {
    ...
    const lastNameNode = schema.node('inline_rdfa', {
      rdfaNodeType: 'literal',
    ...
    const personNode = schema.node('inline_rdfa', {
    ...
    const mandateeNode = schema.node('inline_rdfa', {
      rdfaNodeType: 'resource',
